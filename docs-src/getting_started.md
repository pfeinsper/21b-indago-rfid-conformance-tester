...
![Platform Designer](platform_designer.png){ style="width: 80%; display: block; margin: auto" }
...
![Testbench settings](generate_tb2.png){ style="width: 90%; display: block; margin: auto" }
...
![Importing project](import_project.png){ style="width: 80%; display: block; margin: auto" }
...
![Importing project](import_project2.png){ style="width: 80%; display: block; margin: auto" }
...
![BSP editor](bsp_modelsim.png){ style="width: 90%; display: block; margin: auto" }
...
![Generating HDL](generate_hdl.png){ style="width: 80%; display: block; margin: auto" }
...
![Hardware Setup](hw_setup.png){ style="width: 80%; display: block; margin: auto" }
...
![Device name](device_chip.png){ style="width: 60%; display: block; margin: auto" }
...
![GPIO schematic](gpio.png){ style="height: 40%; display: block; margin: auto" }
...
![BSP editor](bsp_hw.png){ style="width: 90%; display: block; margin: auto" }
